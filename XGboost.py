...
df = pd.get_dummies(df, columns=["Day", "import xgboost as xgb
import pandas as pd
from sklearn.model_selection import train_test_split
from sklearn.preprocessing import OneHotEncoder
import numpy as np
...
print("Best study/sleep hours for CGPA 3.5:", best_combination)", "Marital Status", "Your gender?"], drop_first=True)
